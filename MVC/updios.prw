...
/*/
//--------------------------------------------------------------------
User Function UPDIOS( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDIOS" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDIOS" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
	'ZA7_FILIAL+ZA7_CODIGO'													, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX2, { ;
	...
	'Musicas da Playlist'													, ; //X2_NOME
	'Musicas da Playlist'													, ; //X2_NOMESPA
	'Musicas da Playlist'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
	'ZA8_FILIAL+ZA8_PLAY+ZA8_MUSICA'										, ; //X2_UNICO
	''																		, ; //X2_DISPLAY
	''																		, ; //X2_SYSOBJ
	''																		, ; //X2_USROBJ
	'1'																		, ; //X2_POSLGT
...
aAdd( aSX3, { ;
	...
	{ 'Codigo'																, .T. }, ; //X3_TITSPA
	{ 'Codigo'																, .T. }, ; //X3_TITENG
	{ 'Codigo da Playlist'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo da Playlist'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo da Playlist'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(32) + Chr(32)							, .T. }, ; //X3_USADO
	{ 'GETSXENUM("ZA7","ZA7_CODIGO")'										, .T. }, ; //X3_RELACAO
	{ ''																	, .T. }, ; //X3_F3
	{ 0																		, .T. }, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	{ 'Owner'																, .T. }, ; //X3_TITSPA
	{ 'Owner'																, .T. }, ; //X3_TITENG
	{ 'Dono da Playlist'													, .T. }, ; //X3_DESCRIC
	{ 'Dono da Playlist'													, .T. }, ; //X3_DESCSPA
	{ 'Dono da Playlist'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
...
aAdd( aSX3, { ;
	...
	{ 8																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Data Criação'														, .T. }, ; //X3_TITULO
	{ 'Data Criação'														, .T. }, ; //X3_TITSPA
	{ 'Data Criação'														, .T. }, ; //X3_TITENG
	{ ''																	, .T. }, ; //X3_DESCRIC
	{ ''																	, .T. }, ; //X3_DESCSPA
	{ ''																	, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ 'Path'																, .T. }, ; //X3_TITSPA
	{ 'Path'																, .T. }, ; //X3_TITENG
	{ 'Diretório com os mp4'												, .T. }, ; //X3_DESCRIC
	{ 'Diretório com os mp4'												, .T. }, ; //X3_DESCSPA
	{ 'Diretório com os mp4'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Descricao da playlist'												, .T. }, ; //X3_DESCRIC
	{ 'Descricao da playlist'												, .T. }, ; //X3_DESCSPA
	{ 'Descricao da playlist'												, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
...
aAdd( aSX3, { ;
	...
	{ 'Premium'																, .T. }, ; //X3_TITSPA
	{ 'Premium'																, .T. }, ; //X3_TITENG
	{ 'Playlist Premium'													, .T. }, ; //X3_DESCRIC
	{ 'Playlist Premium'													, .T. }, ; //X3_DESCSPA
	{ 'Playlist Premium'													, .T. }, ; //X3_DESCENG
	{ ''																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	{ 6																		, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Cod.Playlist'														, .T. }, ; //X3_TITULO
	{ 'Cod.Playlist'														, .T. }, ; //X3_TITSPA
	{ 'Cod.Playlist'														, .T. }, ; //X3_TITENG
	{ 'Codigo da Playlist'													, .T. }, ; //X3_DESCRIC
	{ 'Codigo da Playlist'													, .T. }, ; //X3_DESCSPA
	{ 'Codigo da Playlist'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
...
aAdd( aSX3, { ;
	...
	{ 'Titulo da Musica'													, .T. }, ; //X3_DESCRIC
	{ 'Titulo da Musica'													, .T. }, ; //X3_DESCSPA
	{ 'Titulo da Musica'													, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
	...
	{ ''																	, .T. }, ; //X3_PICTVAR
	{ ''																	, .T. }, ; //X3_WHEN
	{ 'Posicione("ZA1", 1, xFilial("ZA1") + ZA8->ZA8_MUSICA, "ZA1_TITULO")'		, .T. }, ; //X3_INIBRW
	{ ''																	, .T. }, ; //X3_GRPSXG
	{ ''																	, .T. }, ; //X3_FOLDER
	{ ''																	, .T. }, ; //X3_CONDSQL
	{ ''																	, .T. }, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	{ 'Codigo do Album'														, .T. }, ; //X3_DESCRIC
	{ 'Codigo do Album'														, .T. }, ; //X3_DESCSPA
	{ 'Codigo do Album'														, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
...
aAdd( aSX3, { ;
	...
	{ 60																	, .T. }, ; //X3_TAMANHO
	{ 0																		, .T. }, ; //X3_DECIMAL
	{ 'Arquivo MP3'															, .T. }, ; //X3_TITULO
	{ 'Arquivo MP3'															, .T. }, ; //X3_TITSPA
	{ 'Arquivo MP3'															, .T. }, ; //X3_TITENG
	{ 'Nome do arquivo da musica'											, .T. }, ; //X3_DESCRIC
	{ 'Nome do arquivo da musica'											, .T. }, ; //X3_DESCSPA
	{ 'Nome do arquivo da musica'											, .T. }, ; //X3_DESCENG
	{ '@!'																	, .T. }, ; //X3_PICTURE
	{ ''																	, .T. }, ; //X3_VALID
	{ Chr(120) + Chr(32) + Chr(32) + Chr(32) + Chr(32) + ;
	Chr(32) + Chr(32) + Chr(32) + Chr(120) + Chr(32) + ;
...
aAdd( aSIX, { ;
	'ZA8'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZA8_FILIAL+ZA8_PLAY+ZA8_MUSICA'										, ; //CHAVE
	'Playlist e Musica'														, ; //DESCRICAO
	'Playlist e Musica'														, ; //DESCSPA
	'Playlist e Musica'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'N'																		} ) //SHOWPESQ
...
aAdd( aSX7, { ;
	...
	'ZA8_TITULO'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'ZA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("ZA1") + M->ZA8_MUSICA'										, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Playlist Premium' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PZA7_PREMIU", aHlpPor, aHlpEng, aHlpSpa, .T. )
AutoGrLog( "Atualizado o Help do campo " + "ZA7_PREMIU" )
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDIOS" ) ) ) ;
